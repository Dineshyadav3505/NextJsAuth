  ...
  return (
    <div>
      ...
      <p className="py-3 md:py-9 text-3xl md:text-5xl lg:leading-[50px] tracking-tighter drop-shadow-[0_0px_15px_rgba(255,255,255,0.6)]">
        ...
        <span className=" font-Gloock tracking-wide"> empower and engage people.
        </span>
      </p>
      ...
      <div className="my-10 md:flex gap-3 ">
        <div className=" border-[1px] border-[rgba(114,112,112,0.5)] w-full md:w-[45%] rounded-xl p-2 bg-[rgba(114,112,112,0.3)]">
            <img className=" rounded-md h-[600px] w-full object-cover" src="https://images.unsplash.com/photo-1723965453045-b025e5b3af13?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="profile image" />
        </div>
        <div className="md:w-[55%] py-10 flex flex-col justify-center items-center text-center md:text-left md:items-start md:px-4 text-base md:text-xl space-y-6">
            ...
            <p>In June 2024, I graduated from Chandigarh University in Punjab, India. There, I became obsessed with web development.</p>
            <p>I have always been passionate about three things: creating digital designs, development, and experimenting with web animation. Through my interest in design, I have always wanted to use my skills to make others happy and help them enjoy what they see visually.</p>
        </div>
